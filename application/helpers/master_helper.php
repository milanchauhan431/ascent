...
function getMasterDtHeader($page){
    ...
    $data['finish_goods'][] = ["name"=>"GST Per"];
    $data['finish_goods'][] = ["name"=>"Remark"];
...
function getProductData($data){
    ...
    return [$action,$data->sr_no,$data->item_code,$data->item_name,$data->category_name,$data->unit_name,$data->hsn_code,$data->gst_per,$data->note];
}